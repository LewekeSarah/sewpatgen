...
if __name__ == "__main__":
    ...
    export_pattern_part_svg_mm(
        part, width_mm=DinA0.width, height_mm=DinA0.height, filename="women/blouse.svg"
    )
